...
If you want the moveset to stay constantly, use the "Online Player" buttons, and BEFORE the loading screen. Both online players must load the same moveset on the same players.
 1.0.21 Changelog:
- [EDITOR] Add 'Go to' buttons for cancels, group cancels, hit conditions, reaction-lists
- [EDITOR] Add button to list cancels/group_cancels/reaction_list that references the current selected move
- [EDITOR] Add button to go to 2P move id
